      ...
      <div className="section-container py-spacing-xl">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-spacing-lg mb-spacing-lg">
          <div className="md:col-span-12 lg:col-span-5">
            <h3 className="font-heading text-4xl font-black mb-spacing-sm text-white uppercase tracking-tighter">{practiceProfile.brandName}</h3>
          ...
          <div className="md:col-span-6 lg:col-span-4">
            ...
            <div className="flex flex-col gap-6 text-neutral-400">
              <a href={practiceProfile.contact.phoneHref} className="group flex items-center gap-4 hover:text-white transition-colors">
                ...
                <span className="text-lg">{practiceProfile.contact.phoneDisplay}</span>
              </a>
              <a href={`mailto:${practiceProfile.contact.email}`} className="group flex items-center gap-spacing-sm hover:text-white transition-colors">
                <span className="w-10 h-10 rounded-editorial-md bg-neutral-800 flex items-center justify-center group-hover:bg-primary-900 transition-colors">
                ...
                <span className="text-lg text-balance">{practiceProfile.contact.email}</span>
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-neutral-800 py-spacing-md flex flex-col md:flex-row justify-between items-center gap-spacing-md">
          <p className="text-neutral-500 text-sm" suppressHydrationWarning>
            &copy; {currentYear} {practiceProfile.businessName}. {t('allRightsReserved') || 'All rights reserved.'}
          </p>
